...
game_font=pygame.font.Font('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/04B_19.ttf',40)   #phong chu
...
#chen background
bg=pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/background-night.png').convert()   # lay hinh anh tu file
bg=pygame.transform.scale2x(bg)  # nhan doi background, chiem het khung hinh game

#chen san
floor=pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/floor.png').convert()
...
bird_down=pygame.transform.scale2x(pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/yellowbird-downflap.png').convert_alpha())
bird_mid=pygame.transform.scale2x(pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/yellowbird-midflap.png').convert_alpha())
bird_up=pygame.transform.scale2x(pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/yellowbird-upflap.png').convert_alpha())
...
#tao ong
pipe_surface=pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/obstacle.png').convert()
...
game_over_surface=pygame.transform.scale2x(pygame.image.load('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/Images/gameover.png').convert_alpha())
...
flap_sound=pygame.mixer.Sound('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/sound/sfx_wing.wav')  #chen tieng vo canh cua chim
hit_sound=pygame.mixer.Sound('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/sound/sfx_die.wav')  # chen am thanh khi dam trung cot
score_sound=pygame.mixer.Sound('C:/Users/Admin/Desktop/Bùi Đức Dương - B19DCCN145/FileGame/sound/sfx_point.wav')  #chen am thanh khi duoc diem
